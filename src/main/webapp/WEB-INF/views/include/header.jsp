        ...
        <nav class="navbar navbar-static-top" role="navigation">
          ...
          <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
              ...
              <li>
              	<a href="javascript:sendAndroidMsg('010-4603-2283')">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="/board/listPage.sinc"><i class="fa fa-clipboard" aria-hidden="true"></i>게시판</a></li>
